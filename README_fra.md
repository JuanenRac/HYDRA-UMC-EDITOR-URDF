...
├── LICENSE                         # GPL-3.0
├── assets/
│   ├── HYDRA_UMC_ICON.svg          # Marque HYDRA-UMC animée utilisée par le panneau Qt Quick
│   ├── qml/CommandDeck.qml         # Panneau Qt Quick; délègue aux widgets/actions existants
...
│       ├── qtquick_deck.py         # Pont QObject entre CommandDeck.qml et l'espace de travail existant
...
- **[HYDRA-UMC-STUDIO](https://github.com/JuanenRac/HYDRA-UMC-STUDIO)** — le catalogue de modèles que cet éditeur existe pour peupler ; le résultat final est poussé directement vers un serveur STUDIO en cours d'exécution.
- **[HYDRA-UMC-SERVER](https://github.com/JuanenRac/HYDRA-UMC-SERVER)** — détient le véritable point de terminaison `POST /api/models/submit` vers lequel cet éditeur pousse les modèles terminés.
...
- 🎮 **Jumeau Numérique et Simulation :** [HYDRA-UMC-HIL-BRIDGE](https://github.com/JuanenRac/HYDRA-UMC-HIL-BRIDGE)
...
- 🛠️ **Outils Complémentaires :** [URTC-SMART-RACK](https://github.com/JuanenRac/URTC-SMART-RACK), [URTC-VISION-TOOL](https://github.com/JuanenRac/URTC-VISION-TOOL), [HYDRA-UMC-WATCH](https://github.com/JuanenRac/HYDRA-UMC-WATCH), [HYDRA-UMC-TOOL-CLI](https://github.com/JuanenRac/HYDRA-UMC-TOOL-CLI), [HYDRA-UMC-DASHBOARD-AI](https://github.com/JuanenRac/HYDRA-UMC-DASHBOARD-AI)
