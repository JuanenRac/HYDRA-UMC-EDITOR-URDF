...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — geplant: eine native Touch-UI für den eigenen 5"/7"-DSI-Touchscreen (1280×720, gleiche Auflösung bei beiden Größen) von HYDRA-UMC auf dem Compute Module 5, die denselben Server direkt vom Board aus steuert. Noch nicht begonnen.
