...
├── tests/                          # 実際の pytest スイート(188 件のテスト)—— 純粋なロジックのみ、ここでは PySide6 のインポートは一切なし
...
**直接関連**
- **[HYDRA-UMC-EDITOR-STL](https://github.com/JuanenRac/HYDRA-UMC-EDITOR-STL)** — 本ツールが編集する URDF/運動学側ではなく、同じモデルカタログの生の STL ジオメトリを扱う姉妹デスクトップエディタ。
