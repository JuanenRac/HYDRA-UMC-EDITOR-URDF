...
- **[HYDRA-UMC-STUDIO](https://github.com/JuanenRac/HYDRA-UMC-STUDIO)** — the model catalog this editor exists to populate; the finished result is pushed straight to a running STUDIO server.
